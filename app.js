...
const DESTINATIONS = [
  ...
  },
  {
    ...
    advice: '高地保暖风 · 北地旅行', lookTitle: '北地保暖叠穿',
  ...
  },
  {
    ...
    advice: '高原户外美学 · 亮色冲锋', lookTitle: '高原亮色机能',
  ...
  },
  {
    ...
    advice: '山地旅行风 · 酒红苔绿奶白', lookTitle: '山地酒红针织',
  ...
  },
  {
    ...
    advice: '彩林出片风 · 柔和针织撞色', lookTitle: '彩林撞色针织',
  ...
  },
  {
    ...
    advice: '都市赏秋风 · 通勤街拍', lookTitle: '都市通勤风衣',
  ...
  },
  {
    ...
    advice: '新中式秋游风 · 复古文艺', lookTitle: '新中式复古',
  ...
  },
  {
    ...
    advice: '江南轻复古 · 奶咖针织', lookTitle: '江南奶咖针织',
  ...
  },
  {
    ...
    advice: '暖调文艺风 · 奶油姜黄焦糖', lookTitle: '暖调银杏文艺',
  ...
  },
  {
    ...
    advice: '古村氛围风 · 复古夹克', lookTitle: '古村复古夹克',
  ...
  },
  {
    ...
    advice: '高原户外风 · 亮色机能', lookTitle: '高原亮色机能',
  ...
  },
  {
    ...
    advice: '西北旷野风 · 大地色廓形', lookTitle: '旷野大地色',
  ...
  },
  {
    ...
    advice: '新中式古都风 · 复古文艺', lookTitle: '新中式古都',
  ...
  },
  {
    ...
    advice: '山系机能风 · 深色利落', lookTitle: '山系机能',
  ...
  },
  {
    ...
    advice: '都市街拍风 · 慵懒高级', lookTitle: '都市街拍',
  ...
  },
  {
    ...
    advice: '江南温柔风 · 奶咖针织', lookTitle: '江南温柔',
  ...
  },
  {
    ...
    advice: '岭南暖秋风 · 轻薄明快', lookTitle: '岭南暖秋',
  ...
  },
  {
    ...
    advice: '山地旅行风 · 硬朗有型', lookTitle: '山地旅行',
  ...
  },
  {
    ...
    advice: '复古民族风 · 暖色编织', lookTitle: '复古民族',
...
/* ============================================================
   ...
   本轮用 Python + Pillow 读取底图尺寸，并基于底图地标 / 地形特征
   手动视觉标定 6 个覆盖中国四角的控制点，再用 numpy 最小二乘
   反推仿射变换矩阵。
   控制点（经纬度 → 底图实测像素）：
     北京·天安门         (116, 40) → (1725,  650)
     上海·东方明珠       (121, 31) → (1980,  985)
     广州/从化·珠江口    (113, 23) → (1645, 1340)
     乌鲁木齐/新疆西端   ( 87, 43) → ( 650,  560)
     漠河·黑龙江最北     (122, 53) → (1778,  145)
     海南三亚·海南岛南端 (109, 18) → (1515, 1585)
   拟合矩阵直接输出底图归一化坐标：
     fx = ax·lon + bx·lat + cx
     fy = ay·lon + by·lat + cy
   ============================================================ */
...
function projectPoint(lon, lat) {
  ...
  // 使用统一仿射矩阵投影全部目的地；内部经纬度坐标不变。
  let fx = P.ax * lon + P.bx * lat + P.cx;
  let fy = P.ay * lon + P.by * lat + P.cy;
